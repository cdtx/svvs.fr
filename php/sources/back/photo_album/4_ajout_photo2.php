            ...
            <div class="container">
              ...
              <div class="mws-panel grid_4">
                  <div class="mws-panel-header">
                      <span><i class="icon-pictures"></i> Ajouter des nouvelles photos</span>
                    </div>
...
if(isset($_FILES['files'])){
  ...
  foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){
    ...
    $file_type=$_FILES['files']['type'][$key];  
        $sql="INSERT into photo (`id`,`name`,`album`,`lien`) VALUES('','$file_name','$id','$lien'); ";
        $desired_dir="../../images/photo/";
...
<form action="" method="POST" enctype="multipart/form-data">
  ...
  <input type="submit" class="btn btn-primary" value="upload" onclick="affiche_chargement()"><p>
