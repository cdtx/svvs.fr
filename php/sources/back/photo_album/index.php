        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    <a href="ajout_album.php" class="btn btn-primary">Crée un album</a>
                    <form action="supp_album.php" method="post" enctype="multipart/form-data"></p>
    ...
    for (var i = 0; i < elements.length; i++) {
        if (elements[i].type == 'checkbox' && elements[i].name == name) {
            elements[i].checked = ref.checked;
                    ...
                    <div class="mws-panel-body">Séléctionner tous les albums <input onclick="CocheTout(this, 'option[]');" type="checkbox">
...
?>
                			<li>
                                <a href="album_solo.php?id=<?php echo $id?>" class="mws-gallery-btn">
                                <?php echo $album;?><br/>
                            	<span class="thumbnail"><img src="../../images/<?php echo $thumb;?>" alt="" height="113px"></span>
...
?>  			
            ...
            <div class="mws-panel grid_1">
                <input type="submit" class="btn btn-primary" value="supprimer album" onclick="return confirm('êtes vous sur de vouloir supprimer cette album ?');">
                </form>
            </div>
                <!-- Panels End -->
            </div>
