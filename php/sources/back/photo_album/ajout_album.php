            ...
            <div class="container">
              ...
              <div class="mws-panel grid_4">
                  <div class="mws-panel-header">
                      <span><i class="icon-pictures"></i> Création d'un album</span>
                    </div>
...
<form action="create_album.php" method="POST" enctype="multipart/form-data">
  Nom de l'album: <input type="text" name="album" multiple/>
</p>
  <input type="submit" class="btn btn-primary" value="créer album" ><p>
