            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Nouvelle vidéo</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_new_video.php" method="post" enctype="multipart/form-data">
                            <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Titre de la vidéo</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="titre" class="large">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Description Google</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="google" class="large">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Date</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="mws-datepicker large" readonly="readonly" name="date">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Heure de la vidéo</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="mws-tpicker large" readonly="readonly" name="heure">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Choix du support</label>
                                    <div class="mws-form-item">
                                        <input type="radio" name="support" value="youtube"> Youtube
                                        <input type="radio" name="support" value="daily"> Dailymotion
                                        <input type="radio" name="support" value="vimeo"> Viméo
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Code vidéo</label>
                                    <div class="mws-form-item">
