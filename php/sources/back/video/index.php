        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_6 mws-collapsible">
                    <a href="new_video.php" class="btn btn-primary">Ajouter une vidéo</a><p>
                    <?php 
                    $mess=$_GET['mess'];
                    if ($mess=='') {
...
{ 
    ...
    $datetime=$date."&nbsp&nbsp&nbsp".$heure;

    $support=$mot['support'];
    $code=$mot['codage'];

    if ($support=='youtube') {
        $codage="<iframe width='240' height='141' src='//www.youtube.com/embed/".$code."' frameborder='0' allowfullscreen></iframe>";
    } elseif ($support=='daily') {
        $codage="<iframe frameborder='0' width='240' height='141' src='http://www.dailymotion.com/embed/video/".$code."' allowfullscreen></iframe>";
    }elseif ($support=='vimeo') {
        $codage="<iframe src='//player.vimeo.com/video/".$code."?byline=0&amp;portrait=0&amp;badge=0&amp;color=f43ef7' width='240' height='141' frameborder='0' webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>";
...
?>
                                <tr>
                                    ...
                                    <td><?php echo $codage;?></td>
                                    
                                    <td>
                                        <span class="btn-group">
                                            <a href="suppr_articles.php?id=<?php echo $id;?>" class="btn btn-small" onclick="return confirm('êtes vous sur de vouloir supprimer cette vidéo ?');"><i class="icon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
<?php
