...
?>
    ...
    <li><a href='index.php'>run & bike</a></li>
...
?>                  
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Mise à jour de la page run & bike</span>

                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="update_page.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mws-form-inline">
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <textarea id="texte" style="width:100%;" rows="200" name="texte"><?php echo $texte;?></textarea>
