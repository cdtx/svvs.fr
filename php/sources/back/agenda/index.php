        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_6 mws-collapsible">
                    <a href="new_article.php" class="btn btn-primary">Ajouter résultat</a><p>
                    <?php 
                    $mess=$_GET['mess'];
                    if ($mess=='') {
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>&nbsp;Les résultats&nbsp;</span>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="btn-group">
                                            ...
                                            <a href="suppr_articles.php?id=<?php echo $id;?>" class="btn btn-small" onclick="return confirm('êtes vous sur de vouloir supprimer cete soirée ?');"><i class="icon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
<?php
