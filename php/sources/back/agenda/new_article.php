...
if (in_array("agenda/index.php", $lien)) {echo "<li class='active'><a href='../agenda/index.php'><i class='icon-calendar'></i> Résultat</a></li>";}
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Nouveau résultat</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_new_article.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mws-form-inline">
                                ...
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Lieu</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="lieu" class="large">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Coureur résultat</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="coureur" class="large">
