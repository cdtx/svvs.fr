...
include '../config/config.php';
$mess=$_GET['mess'];
$sql = "SELECT * FROM  `marathon_resultat` "; 
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
while($mot = mysql_fetch_assoc($req)) 
{ 
    $id=$mot['id'];
...
?>                  
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Page présentation resultat</span>

                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="update_resultats.php" method="post" enctype="multipart/form-data">
