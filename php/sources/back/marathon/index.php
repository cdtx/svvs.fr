...
<li ><a href="../accueil.php"><i class="icon-home"></i> Accueil</a></li>
                    <li>
                        <a href="../gentleman/index.php"><i class="icon-road"></i> Gentleman</a>

                </li>
                <li class="active"><a href='marathon/index.php'><i class='icon-road'></i> marathon</a>
                                        <ul>
...
include '../config/config.php';
$mess=$_GET['mess'];
$sql = "SELECT * FROM  `marathon_presentation` "; 
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
while($mot = mysql_fetch_assoc($req)) 
{ 
    $id=$mot['id'];
...
?>                  
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Page présentation Gentleman</span>

                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="update_presentation.php" method="post" enctype="multipart/form-data">
