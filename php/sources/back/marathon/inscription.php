...
?>                  
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Page présentation inscriptions</span>

                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="update_inscription.php" method="post" enctype="multipart/form-data">
