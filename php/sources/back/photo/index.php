        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    <a href="4_ajout_photo2.php" class="btn btn-primary">Ajouter photo</a>
...
?>
                			<li>
                            	<span class="thumbnail"><img src="<?php echo $image;?>" alt="" height="113px"></span>
                                <input type="checkbox" name="option[]" value="<?php echo $id;?>">
                                <span class="mws-gallery-overlay">
                                    <a href="<?php echo $image;?>" rel="prettyPhoto[gallery1]" class="mws-gallery-btn"><i class="icon-search"></i></a>
                                </span>
                			</li>
<?php
}
?>  			
            ...
            <div class="mws-panel grid_1">
                <input type="submit" class="btn btn-primary" value="supprimer photos" onclick="return confirm('êtes vous sur de vouloir supprimer ces photos ?');">
                </form>
            </div>
                <!-- Panels End -->
            </div>
