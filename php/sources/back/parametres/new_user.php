...
<div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-magic"></i> Nouveau utilisateur</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                       <form id="mws-validate" class="mws-form" action="envoie_new_user.php" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset class="wizard-step mws-form-inline">
                                ...
                                <div id class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" name="login" class="large">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    <label class="mws-form-label">mots de passe <span class="">*</span></label>
                                    <div class="mws-form-item">
                                        <input type="text" name="mdp" class="large">
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <fieldset class="wizard-step mws-form-inline">
                                ...
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Accès Autorisé </label>
                                    <div class="mws-form-item">
                            ...
                            $req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
                                while($mot = mysql_fetch_assoc($req)) 
                                    ...
                                    ?>
                                            <li><input type="checkbox" id="option" name="option[]" class="" value="<?php echo $id;?>"> <label for="cc"><?php echo $nom;?></label></li>
                                    <?php
                                }
                                    ?>
                                    <?php
                            ...
                            $req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
                                while($mot = mysql_fetch_assoc($req)) 
                                    ...
                                    ?>
                                            <li><input type="checkbox" id="option" name="option[]" class=""> <label for="cc"><?php echo $nom;?></label></li>
                                    <?php
                                }
                                    ?>
                                        </ul>
