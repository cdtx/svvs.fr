...
<table class="border" style="margin-left:40pt;margin-top:10pt">
    ...
    <tr>
        <td><br>Soirée repas dansant<br>20€ par repas</td>
        <td style="width:14%;text-align:right"><?php echo $repas;?>x 20€<br><br><br></td>
        <td style="width:20%">= <?php echo $total_repas;?> €<br><br><br></td>
    </tr>
    <tr>
...
<span class="info" style="margin-top:10pt">ATTENTION !  LE NOMBRE D’INSCRIPTIONS EST LIMITE A 100 EQUIPES.

inscriptions pourront être prises en compte le jour de l’épreuve dans la limite des 

places disponibles avec une majoration de 10€ par équipe.)

L’INSCRIPTION  NE SERA EFFECTIVE QU’APRES PAIEMENT DE L’ENGAGEMENT. 

LES DOSSARDS SERONT REMIS LE JOUR DU DEPART UNIQUEMENT SUR 

PRESENTATION D’UNE LICENCE OU D’UN CERTIFICAT MEDICAL DE NON CONTRE 

INDICATION A LA PRATIQUE DU SORT EN COMPETITION DE MOINS DE 6 MOIS.
</span>
