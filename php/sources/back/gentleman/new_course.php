...
$sql = "truncate table coureur"; 
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
$sql = "truncate table incriptions";
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error());
$sql = "truncate table propriete_gentleman";
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
?>
...
if (in_array("blog/index.php", $lien)) {echo "<li class='active'><a href='../blog/index.php'><i class='icon-blogger'></i> blog</a></li>";}
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-ok"></i> Nouvelle course</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_new_course.php" method="post" enctype="multipart/form-data">
                            <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                            <div class="mws-form-inline">

                                <div class="mws-form-row">
                                    <label class="mws-form-label">Date de la course</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="mws-datepicker large" readonly="readonly" name="date">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Heure de la course</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="mws-tpicker large" readonly="readonly" name="heure">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Nombre de participants</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="large" name="nbr">
                                    </div>
                                </div>
                            </div>
