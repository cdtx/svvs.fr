...
if (in_array("blog/index.php", $lien)) {echo "<li class='active'><a href='index.php'><i class='icon-blogger'></i> blog</a></li>";}
...
?>
    ...
    <li><a href='index.php'>100 pour sang</a></li>
                    </ul>
                </li>
        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_6 mws-collapsible">
                    <a href="new_article.php" class="btn btn-primary">Nouveau article</a><p>
                    <?php 
                    $mess=$_GET['mess'];
                    if ($mess=='') {
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>&nbsp;Article du blog&nbsp;</span>
                    </div>
...
?>
                                <tr>
                                    ...
                                    <td><img src="../../<?php echo $photo;?>" width="80"></td>
                                    <td><?php echo $str;?></td>
                                    <td>
                                        <span class="btn-group">
                                            <a href="modif_article.php?id=<?php echo $id;?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                            <a href="suppr_articles.php?id=<?php echo $id;?>" class="btn btn-small" onclick="return confirm('êtes vous sur de vouloir supprimer cet article ?');"><i class="icon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
<?php
