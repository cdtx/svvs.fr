        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span>Ajout fiche</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_fiche.php" method="post" enctype="multipart/form-data">
...
?>
                                    ...
                                    <div class="mws-form-row">
                                        <label class="mws-form-label">Photo couverture</label>
                                        <div class="mws-form-item">
                      <center>
