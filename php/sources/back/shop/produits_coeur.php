            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        ...
                        <span><i class="icon-table"></i> Les produits coup de coeur</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_modif_coeur.php" method="post" enctype="multipart/form-data"> 
...
$sql ="SELECT * FROM coeur";
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
while($mot = mysql_fetch_assoc($req)) 
{ 
    $coeur[]=$mot['id_produit'];
...
?>
                ...
                <input type="submit" value="Modifié" class="btn btn-success">             
                </div>
                </form>
                </div>
