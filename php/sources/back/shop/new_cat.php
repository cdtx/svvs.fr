            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i> Ajouter une nouvelle catégorie</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="ajout_cat.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <textarea name="texte" id="textludo1"></textarea>
                                    </div>
