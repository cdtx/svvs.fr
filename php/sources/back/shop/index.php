            ...
            <div class="container">
                ...
                <!-- Panels Start -->
                                ...
                                <div class="mws-panel grid_1">
                                    <a href="new_cat.php"><input type="button" value="ajouter categorie" class="btn btn-primary"></a>
                                </div>
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i> Categorie parents</span>
                    </div>
                        ...
                        <table class="mws-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Activée</th>
                                    <th>Nom</th>
                                    <th>Nombre de sous categorie</th>
                                    <th>Nombre de produits</th>
                                    <th>Position dans le menu</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
...
?>
                                <tr>
                                    ...
                                    <td><?php if ($active =='') {
                                    ?>
                                    <center><a href="desactiv.php?id=<?php echo $id;?>"><i class="icol-accept"></i></a></center>
                                    <?php
                                    } else {
                                    ?>
                                    <center><a href="activ.php?id=<?php echo $id;?>"><i class="icol-cross"></i></a></center>
                                    <?php
                                    }
                                    ?>
                                    </td>
                                    <td><?php echo $nom;?></td>
                                    <td><?php echo $nombre_sous;?></td>
                                    <td><?php echo $nombre_prod;?></td>
                                    <td><?php echo $position;?></td>
                                    <td>
                                        <span class="btn-group">
                                    <a href="up.php?id_position=<?php echo $position;?>&amp;id=<?php echo $id;?>"><i class="ui-icon ui-icon-triangle-1-n"></i></a>
                                    <a href="down.php?id_position=<?php echo $position;?>&amp;id=<?php echo $id;?>"><i class="ui-icon ui-icon-triangle-1-s"></i></a>
                                </span>
                                        <span class="btn-group">
                                            <a href="modif_cat.php?id=<?php echo $id;?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                            <a href="suppr_cat.php?id=<?php echo $position;?>" class="btn btn-small" onclick="return confirm('êtes vous sur de vouloir supprimer cette categorie ?');"><i class="icon-trash"></i></a>
                                        </span>
