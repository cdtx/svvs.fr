...
<?php 
$id_cat=$_GET['id'];
$sql ="SELECT produits.titre ,photo_produit.photo, produits.active,produits.id
FROM produits
...
?>
                                <tr>
                                    ...
                                    <td><?php if ($active =='') {
                                    ?>
                                    <center><a href="desactiv_produit.php?id=<?php echo $id;?>"><i class="icol-accept"></i></a></center>
                                    <?php
                                    } else {
                                    ?>
                                    <center><a href="activ_produit.php?id=<?php echo $id;?>"><i class="icol-cross"></i></a></center>
                                    <?php
                                    }
                                    ?></td>
                                    <td>                                        
                                        <span class="btn-group">
                                            <a href="modif_produit.php?id=<?php echo $id;?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                            <a href="suppr_produit.php?id=<?php echo $id;?>" class="btn btn-small" onclick="return confirm('êtes vous sur de vouloir supprimer ce produit ?');"><i class="icon-trash"></i></a>
                                        </span></td>
                                </tr>
<?php
}
