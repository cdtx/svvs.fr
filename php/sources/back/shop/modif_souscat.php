            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i> Modifier sous categorie</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="modif_envoie_souscat.php" method="post" enctype="multipart/form-data">
                            <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                            <div class="mws-form-inline">
                                <div class="mws-form-row">
                                     <?php
$id=$_GET['id'];
$sql = "SELECT * FROM  souscat WHERE id='$id'"; 
$req = mysql_query($sql) or die('Erreur SQL !<br>'.$sql.'<br>'.mysql_error()); 
while($mot = mysql_fetch_assoc($req)) 
{ 
    $nom=$mot['titre'];
...
?>
                                    <label class="mws-form-label">Titre de la sous catégorie</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="name" value="<?php echo $nom;?>">
                                        <input type="hidden" name="parent" value="<?php echo $parent;?>">
                                        <input type="hidden" name="id" value="<?php echo $id;?>">
                                    </p>
                                        <textarea name="texte" id="textludo1"><?php echo $texte;?></textarea>
                                    </div>
                                </p>
