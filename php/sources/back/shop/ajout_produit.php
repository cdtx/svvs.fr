        ...
        <div id="mws-container" class="clearfix">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form id="mws-validate" class="mws-form" action="envoie_produit.php" method="post" enctype="multipart/form-data">
                            <div class="mws-form-inline">
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="medium" name="google">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">Prix</label>
                                    <div class="mws-form-item">
                                        <input type="text" class="medium" name="prix">
                                    </div>
                                </div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">description produit</label>
                                    <div class="mws-form-item">
                                        <textarea rows="" cols="" class="medium" id="textludo1" name="description"></textarea>
                                    </div>
                                </div>
                                <div class="mws-form-row">
...
?>
                                    ...
                                    <div class="mws-form-row">
                                        <label class="mws-form-label">Photo principale</label>
                                        <div class="mws-form-item">
                      <center>
...
<form action="" method="POST" enctype="multipart/form-data">
  <input type="file" name="files[]" />
                            ...
                            <div class="mws-button-row">
                                <input type="submit" value="Ajouter" class="btn btn-danger" onclick="affiche_chargement()">
