...
<table style="width:100%">
	...
	<tr><td>Nom*</td><td><input type="text" name="coureur1" class="text" value="DERNY" autocomplete="off"></td><td><input type="text" name="coureur2" class="text"></td></tr>
	<tr><td>Prenom*</td><td><input type="text" name="prenom1" class="text" value="DERNY" autocomplete="off"></td><td><input type="text" name="prenom2" class="text"></td></tr>
