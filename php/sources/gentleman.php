	...
	<section class="container row clearfix">
		<header class="clearfix">
			<nav id="main-menu" class="left navigation">
				<ul class="sf-menu no-bullet inline-list m0">
		    		...
		    		<li><a href="marathon-relais" class="active">Marathon relais</a>
		    			<ul class="sub-menu">
		...
		<section class="inner-container clearfix">
			...
			<section id="content" class="twelve column row pull-center singlepost">
				...
				<h1 class="post-title">La course</h1>
<?php
include 'nbvcxw.php';
$sql2 = "SELECT * FROM  `gentleman_run` "; 
$req2 = mysql_query($sql2) or die('Erreur SQL !<br>'.$sql2.'<br>'.mysql_error()); 
while($mot2 = mysql_fetch_assoc($req2)) 
{
	echo str_replace('/source', 'administration/source', $mot2['texte']) ;
